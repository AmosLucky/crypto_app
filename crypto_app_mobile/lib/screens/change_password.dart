...
class _ChangePasswordState extends State<ChangePassword> {
  ...
  var oldPasswordCRT = new TextEditingController();
  var comfirmPasswordCRT = new TextEditingController();
  var newPasswordCTR = new TextEditingController();
              ...
              child: Form(
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Button1(
                        onPressed: () async {
                          accountManager.updateUserPassword(userData: {
                            "user_id": accountManager.userModel.id,
                            "new_password": newPasswordCTR.text,
                            "confirm_password": comfirmPasswordCRT.text,
                            "old_password": oldPasswordCRT.text
                          });
